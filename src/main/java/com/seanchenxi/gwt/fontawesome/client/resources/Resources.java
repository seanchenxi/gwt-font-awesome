...
public interface Resources extends ClientBundle {
  ...
  interface Style extends CssResource{
    ...
    @ClassName("fa-shirtsinbulk")
    String faShirtsinbulk();

    @ClassName("fa-y-combinator-square")
    String faYCombinatorSquare();
    ...
    @ClassName("fa-institution")
    String faInstitution();

    @ClassName("fa-search-minus")
    ...
    @ClassName("fa-angle-double-right")
    String faAngleDoubleRight();

    @ClassName("fa-power-off")
    String faPowerOff();

    @ClassName("fa-tumblr-square")
    ...
    @ClassName("fa-y-combinator")
    String faYCombinator();

    @ClassName("fa-internet-explorer")
    String faInternetExplorer();

    @ClassName("fa-credit-card-alt")
    String faCreditCardAlt();
    ...
    @ClassName("fa-sort-alpha-asc")
    String faSortAlphaAsc();

    @ClassName("fa-user-plus")
    String faUserPlus();

    @ClassName("fa-reorder")
    String faReorder();
    ...
    @ClassName("fa-step-backward")
    String faStepBackward();

    @ClassName("fa-deviantart")
    String faDeviantart();
    ...
    @ClassName("fa-chevron-circle-left")
    String faChevronCircleLeft();

    @ClassName("fa-building")
    String faBuilding();

    @ClassName("fa-mixcloud")
    String faMixcloud();

    @ClassName("fa-codiepie")
    String faCodiepie();
    ...
    String faShoppingBasket();

    @ClassName("fa-anchor")
    String faAnchor();

    @ClassName("fa-toggle-right")
    ...
    @ClassName("fa-skyatlas")
    String faSkyatlas();

    @ClassName("fa-times-circle-o")
    ...
    @ClassName("fa-google-plus-square")
    String faGooglePlusSquare();

    @ClassName("fa-toggle-down")
    String faToggleDown();
    ...
    @ClassName("fa-product-hunt")
    String faProductHunt();
    ...
    @ClassName("fa-external-link-square")
    ...
    @ClassName("fa-hourglass-2")
    String faHourglass2();

    @ClassName("fa-hourglass-1")
    String faHourglass1();

    @ClassName("fa-minus-circle")
    String faMinusCircle();

    @ClassName("fa-hourglass-3")
    String faHourglass3();

    @ClassName("fa-mail-forward")
    ...
    @ClassName("fa-arrow-circle-o-down")
    ...
    @ClassName("fa-lightbulb-o")
    String faLightbulbO();

    @ClassName("fa-calendar-times-o")
    String faCalendarTimesO();

    @ClassName("fa-paper-plane-o")
    ...
    @ClassName("fa-arrow-circle-down")
    ...
    String faHourglassStart();

    @ClassName("fa-level-up")
    String faLevelUp();

    @ClassName("fa-file-picture-o")
    String faFilePictureO();

    @ClassName("fa-ioxhost")
    String faIoxhost();

    @ClassName("fa-hand-lizard-o")
    String faHandLizardO();
    ...
    @ClassName("fa-history")
    String faHistory();

    @ClassName("fa-tags")
    String faTags();

    @ClassName("fa-transgender-alt")
    ...
    @ClassName("fa-optin-monster")
    String faOptinMonster();
    ...
    @ClassName("fa-slideshare")
    String faSlideshare();

    @ClassName("fa-behance-square")
    ...
    @ClassName("fa-reddit-alien")
    String faRedditAlien();
    ...
    @ClassName("fa-black-tie")
    String faBlackTie();

    @ClassName("fa-sticky-note-o")
    String faStickyNoteO();
    ...
    @ClassName("fa-navicon")
    String faNavicon();

    @ClassName("fa-calculator")
    String faCalculator();

    @ClassName("fa-caret-square-o-left")
    ...
    @ClassName("fa-arrow-circle-o-right")
    ...
    @ClassName("fa-calendar-minus-o")
    String faCalendarMinusO();
    ...
    @ClassName("fa-calendar-o")
    String faCalendarO();

    @ClassName("fa-cc")
    String faCc();

    @ClassName("fa-file-sound-o")
    String faFileSoundO();

    @ClassName("fa-share-square-o")
    String faShareSquareO();

    @ClassName("fa-map-marker")
    String faMapMarker();

    @ClassName("fa-bookmark-o")
    String faBookmarkO();
    ...
    @ClassName("fa-bitbucket-square")
    String faBitbucketSquare();

    @ClassName("fa-google-wallet")
    ...
    @ClassName("fa-birthday-cake")
    String faBirthdayCake();

    @ClassName("fa-arrow-circle-o-left")
    String faArrowCircleOLeft();

    @ClassName("fa-pinterest-square")
    ...
    @ClassName("fa-mouse-pointer")
    String faMousePointer();
    ...
    String faFortAwesome();

    @ClassName("fa-unsorted")
    String faUnsorted();
    ...
    @ClassName("fa-stack-exchange")
    String faStackExchange();

    @ClassName("fa-fire")
    String faFire();

    @ClassName("fa-mars-stroke-v")
    String faMarsStrokeV();

    @ClassName("fa-cc-diners-club")
    String faCcDinersClub();
    ...
    @ClassName("fa-lemon-o")
    String faLemonO();

    @ClassName("fa-pause-circle")
    String faPauseCircle();
    ...
    String faHandPointerO();

    @ClassName("fa-fire-extinguisher")
    String faFireExtinguisher();

    @ClassName("fa-hand-o-left")
    String faHandOLeft();

    @ClassName("fa-list")
    String faList();

    @ClassName("fa-yc-square")
    String faYcSquare();
    ...
    @ClassName("fa-dropbox")
    String faDropbox();

    @ClassName("fa-opencart")
    String faOpencart();

    @ClassName("fa-building-o")
    String faBuildingO();

    @ClassName("fa-simplybuilt")
    String faSimplybuilt();

    @ClassName("fa-chevron-circle-right")
    ...
    String faShoppingBag();

    @ClassName("fa-medium")
    String faMedium();

    @ClassName("fa-life-bouy")
    String faLifeBouy();
    ...
    String faBatteryQuarter();

    @ClassName("fa-microphone")
    String faMicrophone();

    @ClassName("fa-toggle-left")
    String faToggleLeft();
    ...
    @ClassName("fa-automobile")
    String faAutomobile();

    @ClassName("fa-object-group")
    String faObjectGroup();
    ...
    @ClassName("fa-chevron-circle-up")
    ...
    @ClassName("fa-trademark")
    String faTrademark();

    @ClassName("fa-pied-piper-alt")
    ...
    @ClassName("fa-mortar-board")
    String faMortarBoard();

    @ClassName("fa-sort-alpha-desc")
    String faSortAlphaDesc();

    @ClassName("fa-remove")
    String faRemove();

    @ClassName("fa-folder-open-o")
    String faFolderOpenO();

    @ClassName("fa-step-forward")
    String faStepForward();

    @ClassName("fa-toggle-up")
    String faToggleUp();

    @ClassName("fa-foursquare")
    String faFoursquare();

    @ClassName("fa-google")
    String faGoogle();

    @ClassName("fa-caret-square-o-up")
    ...
    @ClassName("fa-space-shuttle")
    String faSpaceShuttle();

    @ClassName("fa-reddit-square")
    ...
    @ClassName("fa-meanpath")
    String faMeanpath();

    @ClassName("fa-sort-amount-asc")
    String faSortAmountAsc();

    @ClassName("fa-mail-reply-all")
    String faMailReplyAll();

    @ClassName("fa-github")
    String faGithub();

    @ClassName("fa-cc-paypal")
    String faCcPaypal();

    @ClassName("fa-star-half-empty")
    String faStarHalfEmpty();

    @ClassName("fa-mars-stroke-h")
    String faMarsStrokeH();

    @ClassName("fa-frown-o")
    String faFrownO();
    ...
    @ClassName("fa-angle-double-left")
    ...
    @ClassName("fa-stop-circle-o")
    String faStopCircleO();

    @ClassName("fa-paint-brush")
    String faPaintBrush();

    @ClassName("fa-expeditedssl")
    String faExpeditedssl();
    ...
    @ClassName("fa-hacker-news")
    String faHackerNews();

    @ClassName("fa-commenting-o")
    String faCommentingO();
    ...
    @ClassName("fa-stumbleupon")
    String faStumbleupon();

    @ClassName("fa-volume-up")
    String faVolumeUp();

    @ClassName("fa-sort-numeric-asc")
    ...
    String faCalendarPlusO();

    @ClassName("fa-spotify")
    String faSpotify();

    @ClassName("fa-github-alt")
    String faGithubAlt();
    ...
    @ClassName("fa-vimeo-square")
    String faVimeoSquare();

    @ClassName("fa-wikipedia-w")
    String faWikipediaW();
    ...
    @ClassName("fa-hand-rock-o")
    String faHandRockO();

    @ClassName("fa-balance-scale")
    String faBalanceScale();

    @ClassName("fa-creative-commons")
    String faCreativeCommons();

    @ClassName("fa-sign-out")
    String faSignOut();

    @ClassName("fa-thumb-tack")
    String faThumbTack();

    @ClassName("fa-bullhorn")
    String faBullhorn();

    @ClassName("fa-calendar-check-o")
    String faCalendarCheckO();

    @ClassName("fa-gratipay")
    String faGratipay();

    @ClassName("fa-hourglass-end")
    String faHourglassEnd();
    ...
    @ClassName("fa-level-down")
    String faLevelDown();

    @ClassName("fa-buysellads")
    String faBuysellads();
    ...
    @ClassName("fa-caret-square-o-right")
    String faCaretSquareORight();

    @ClassName("fa-forumbee")
    String faForumbee();
    ...
    @ClassName("fa-odnoklassniki-square")
    String faOdnoklassnikiSquare();

    @ClassName("fa-university")
    String faUniversity();
    ...
    @ClassName("fa-tripadvisor")
    String faTripadvisor();

    @ClassName("fa-chevron-circle-down")
    String faChevronCircleDown();

    @ClassName("fa-comment-o")
    String faCommentO();

    @ClassName("fa-file-photo-o")
    String faFilePhotoO();
    ...
    String faHourglassHalf();

    @ClassName("fa-bug")
    String faBug();

    @ClassName("fa-odnoklassniki")
    String faOdnoklassniki();
    ...
    @ClassName("fa-battery-1")
    String faBattery1();

    @ClassName("fa-clock-o")
    String faClockO();

    @ClassName("fa-battery-0")
    String faBattery0();

    @ClassName("fa-map-signs")
    String faMapSigns();
    ...
    @ClassName("fa-soccer-ball-o")
    String faSoccerBallO();

    @ClassName("fa-cut")
    String faCut();

    @ClassName("fa-phone-square")
    String faPhoneSquare();

    @ClassName("fa-firefox")
    String faFirefox();

    @ClassName("fa-caret-square-o-down")
    String faCaretSquareODown();

    @ClassName("fa-ambulance")
    String faAmbulance();

    @ClassName("fa-tv")
    String faTv();

    @ClassName("fa-turkish-lira")
    String faTurkishLira();

    @ClassName("fa-pause-circle-o")
    String faPauseCircleO();
    ...
    @ClassName("fa-fast-backward")
    String faFastBackward();

    @ClassName("fa-television")
    String faTelevision();
    ...
    @ClassName("fa-hand-scissors-o")
    String faHandScissorsO();
